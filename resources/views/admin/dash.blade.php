                      ...
                      <div class="table-responsive">
                        <table class="table custom-table text-dark">
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <img src="{{ URL::asset('public/dashboard/assets/images/dashboard/img_1.jpg') }}" class="mr-2" alt="image" /> Jacob Jensen </td>
                              <td>
                                <div class="d-flex">
                            ...
                            <tr>
                              <td>
                                <img src="{{ URL::asset('public/dashboard/assets/images/dashboard/img_1.jpg') }}" class="mr-2" alt="image" /> Cecelia Bradley </td>
                              <td>
                                <div class="d-flex">
                            ...
                            <tr>
                              <td>
                                <img src="{{ URL::asset('public/dashboard/assets/images/dashboard/img_1.jpg') }}" class="mr-2" alt="image" /> Leah Sherman </td>
                              <td>
                                <div class="d-flex">
                            ...
                            <tr>
                              <td>
                                <img src="{{ URL::asset('public/dashboard/assets/images/dashboard/img_1.jpg') }}" class="mr-2" alt="image" /> Ina Curry </td>
                              <td>
                                <div class="d-flex">
                            ...
                            <tr>
                              <td>
                                <img src="{{ URL::asset('public/dashboard/assets/images/dashboard/img_1.jpg') }}" class="mr-2" alt="image" /> Lida Fitzgerald </td>
                              <td>
                                <div class="d-flex">
                            ...
                            <tr>
                              <td>
                                <img src="{{ URL::asset('public/dashboard/assets/images/dashboard/img_1.jpg') }}" class="mr-2" alt="image" /> Stella Johnson </td>
                              <td>
                                <div class="d-flex">
                            ...
                            <tr>
                              <td>
                                <img src="{{ URL::asset('public/dashboard/assets/images/dashboard/img_1.jpg') }}" class="mr-2" alt="image" /> Maria Ortiz </td>
                              <td>
                                <div class="d-flex">
                                  <span class="pr-2 d-flex align-items-center">65%</span>
