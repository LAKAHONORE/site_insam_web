    ...
    <body>
        ...
        <div class="container-fluid bg-breadcrumb animate__animated animate__fadeIn">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 animate__animated animate__bounce"> <span class="animate__animated animate__flip">About Us</span></h1>
        ...
        @include('Component.Cycle')


        @include('Component.Partenaires')
